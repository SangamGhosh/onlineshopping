...
%>
 ...
 <%
      ...
      %>       
        ...
        ResultSet rs2=st.executeQuery("select *from signup where email='"+email+"'");
        while(rs2.next())
        {
         %>
        </tbody>
...
<button class="button" type="submit">Procced to Generate Bill<i class='far fa-arrow-alt-circle-right'></i></button>
